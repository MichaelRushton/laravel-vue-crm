<template>
    <nav
        class="border-neutral-default fixed top-0 flex w-full border-b bg-white"
    >
        <div
    ...
    <aside
        class="border-neutral-default fixed top-0 z-10 flex h-screen w-60 flex-col overflow-y-auto border-r bg-white duration-300"
